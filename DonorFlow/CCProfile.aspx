<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CCProfile.aspx.cs" Inherits="DonorFlow.CCProfile" %>
    ...
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <Label style="color:forestgreen; font-weight:bold; margin-bottom:10px;">Campaign Creator</Label>   
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Name</label><asp:TextBox ID="txtFullName" runat="server" CssClass="form-control" Placeholder="Full Name"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-12"><label class="labels">Mobile Number</label><asp:TextBox ID="txtMobileNo" runat="server" CssClass="form-control" Placeholder="Mobile No"></asp:TextBox></div>
                    <div class="col-md-12"><label class="labels">Address</label><asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" Placeholder="Address"></asp:TextBox></div>
                    <div class="col-md-12"><label class="labels">Email ID</label><asp:TextBox ID="txtEmailId" runat="server" CssClass="form-control" Placeholder="Email ID"></asp:TextBox></div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6"><label class="labels">Date of Birth</label><asp:TextBox ID="txtDob" runat="server" CssClass="form-control" Placeholder="DOB" TextMode="Date"></asp:TextBox></div>
                    <div class="col-md-6"><label class="labels">Status</label><asp:TextBox ID="txtStatus" runat="server" CssClass="form-control" Placeholder="Status" ReadOnly="true"></asp:TextBox></div>
                </div>
