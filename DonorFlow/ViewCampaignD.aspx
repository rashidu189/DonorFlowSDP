<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewCampaignD.aspx.cs" Inherits="DonorFlow.ViewCampaignD" %>
...
<script type="text/javascript">
    ...
    function loadCampaigns() {
        $.ajax({
            type: "POST",
            url: "ViewCampaignD.aspx/GetCampaigns",
                ...
                response.d.forEach(campaign => {
                    campaignsContainer.innerHTML +=
                        <div class="campaign-card">
                            ...
                            <a href="CampaignInfoD.aspx?CampaignId=${encodeURIComponent(campaign.Campaign_ID)}" class="btn btn-primary">View Details</a>
                        </div>;
