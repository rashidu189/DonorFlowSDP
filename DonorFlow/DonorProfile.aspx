<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DonorProfile.aspx.cs" Inherits="DonorFlow.DonorProfile" %>
        ...
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" style="width:150px;" 
                    ...
                    <Label style="color:forestgreen; font-weight:bold; margin-bottom:10px;">Donor</Label>
